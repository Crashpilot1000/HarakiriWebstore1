...
#define UBX_SET_19200           "$PUBX,41,1,0003,0001,19200,0*23\r\n"
#define UBX_SET_38400           "$PUBX,41,1,0003,0001,38400,0*26\r\n"
#define UBX_SET_57600           "$PUBX,41,1,0003,0001,57600,0*2D\r\n"
#define UBX_SET_115200          "$PUBX,41,1,0003,0001,115200,0*1E\r\n"
...
void UbloxForceBaud(uint32_t baud)
{
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        {
        case 19200:
            gpsPrint(UBX_SET_19200);
            break;
        case 38400:
            gpsPrint(UBX_SET_38400);
            break;
        case 57600:
            gpsPrint(UBX_SET_57600);
            break;
        case 115200:
            gpsPrint(UBX_SET_115200);
            break;
        }
    }
